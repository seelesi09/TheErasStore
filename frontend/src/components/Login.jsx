...
const Login = ({ onLoginSuccess, onSwitchToSignup }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] flex items-center justify-center px-4 py-8 font-folklore">
        ...
        <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 py-4 px-6 text-base bg-white text-black font-semibold rounded-full hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 shadow-lg"
            >
              {loading ? (
