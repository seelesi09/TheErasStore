...
function App() {
  ...
  useEffect(() => {
    axios.get('https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/albums')
  ...
  const fetchProducts = async () => {
    setLoading(true);
    axios.get('https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/produk')
      .then((res) => {
  ...
  useEffect(() => {
    const fetchOriginalProducts = async () => {
      try {
        const response = await axios.get('https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/produk');
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    axios.post('https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/login', { username: formAuth.username, password: formAuth.password })
      .then((res) => {
  ...
  const handleSaveProduct = (e, payload = null) => {
    ...
    if (editId) {
      ...
      axios.put(`https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/produk/${editId}`, formData, config)
        .then(() => {
      ...
      axios.post('https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/produk', formData, config)
        .then(() => {
  ...
  const handleDeleteProduct = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/produk/${id}`)
          .then(() => {
  ...
  const handleRealAddToCart = async (productID) => {
    ...
    try {
      const response = await axios.post('https://era-store.up.railway.app/theerasstore-production.up.railway.app/api/keranjang', {
        User_ID: user.ID,
        Produk_ID: productID
      });
